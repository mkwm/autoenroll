...
admin.click()
wait.until(lambda driver: 'Select enrollment to configure from the list bellow.' in driver.page_source)
configure = driver.find_element_by_xpath("//*[contains(text(), 'Configure')]")
configure.click()
